...
export default function SearchForm() {
  ...
  const handleInputFocus = (field) => {
    if (field === 'from_city') setShowFromList(true);
    if (field === 'to_city') setShowToList(true);
  };
            ...
            <div className={styles.row}>
              <div className={styles.inputWrapper}>
                <input
                  ...
                  onFocus={() => handleInputFocus('from_city')}
                />
                ...
                {showFromList && (
                  <ul className={styles.dropdown}>
                    {getFilteredCities(form.from_city_name).length > 0 ? (
                      ...
                      <li style={{ color: '#999', padding: '10px' }}>
                        Не найдено
                      </li>
                    )}
                  </ul>
              ...
              <div className={styles.inputWrapper}>
                <input
                  ...
                  onFocus={() => handleInputFocus('to_city')}
                />
                <img src={iconLocation} alt="loc" className={styles.icon} />
                {showToList && (
                  <ul className={styles.dropdown}>
              ...
              <div className={styles.inputWrapper}>
                ...
                {showCalendar && calendarField === 'date_start' && (
                  <Datepicker
                    ...
                    onChange={(val) => {
                      dispatch(
                        setSearchField({ field: 'date_start', value: val })
                      );
                      setShowCalendar(false);
                    }}
                  />
              ...
              <div className={styles.inputWrapper}>
                ...
                {showCalendar && calendarField === 'date_end' && (
                  <Datepicker
                    ...
                    onChange={(val) => {
                      dispatch(
                        setSearchField({ field: 'date_end', value: val })
                      );
                      setShowCalendar(false);
                    }}
                  />
